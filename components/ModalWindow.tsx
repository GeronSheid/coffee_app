...
export const ModalWindow = ({closeFunc}: {closeFunc: () => void}) => {
    ...
    return (
        <div className='fixed top-0 left-0 bottom-0 right-0 bg-black bg-opacity-70 flex items-center justify-center'>
            <div className='bg-black w-[40vw] min-h-[50vh] rounded-3xl p-8'>
                <Form {...form}>
